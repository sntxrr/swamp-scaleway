...
| --- | --- | --- | --- |
| `@sntxrr/scaleway-instance` | Compute Instances | sync, action, list | 🚧 in progress |
| _more Wave 1 core services_ | block-storage, object-storage, vpc, load-balancer, rdb, dns | — | 🚧 planned |
